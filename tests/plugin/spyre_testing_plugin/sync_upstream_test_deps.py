...
_GENERATED_HEADER = (
    "    # Net-new upstream vLLM test deps (issue #447) — GENERATED by\n"
    "    # sync_upstream_test_deps from ALLOW_LIST. Do not hand-edit; edit the\n"
    "    # allow-list and re-run. Versions/extras track vLLM cuda.in.\n"
)
